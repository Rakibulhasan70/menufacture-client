            ...
            <div class=" bg-base-100 gird grid-cols-1 lg:grid-cols-4 flex justify-center items-center" >
                <div className=''>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        />
                        <br /> */}
                        <input className='border-2 mt-2 rounded-md' type="number" name="number" id="" placeholder='Number' />
                        <br />
                        <input type="submit" value="Add" className='bg-indigo-500 border-2 mt-2 px-3 py-2 rounded ' />
                    </form>
                </div>
            </div>
        </div>
